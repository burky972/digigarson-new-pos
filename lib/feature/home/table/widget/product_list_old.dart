...
//               return ListView(
//                 children: btnList.map((button) {
//                   return Padding(
//                     padding: const EdgeInsets.all(1.0),
//                     child: InkWell(
//                       onTap: () async {
//                         switch (button) {
//                           //TODO: CHECK LATER ALL DIALOGS
//                           case "Cover":
...
//                                 .where((product) => product.status != 0 && product.isServe != true)
//                                 .toList();
...
//                               context.read<BranchCubit>().setSectionMoveSelected(
//                                   context.read<BranchCubit>().branchModel!.sections!.first);
...
//                               var filteredProducts = productList
//                                   .where((product) => product.user != null && product.status == 1)
//                                   .toList();
...
//                             break;
//                           //! edit customer count
//                           case "Edit customer count":
//                             if (state.selectedTable!.orders.isNotEmpty) {
//                               // EditCustomerCountDialog().show(context);
//                             } else {
//                               showOrderDialogWithOutCustomDuration(
//                                   context, 'Kapalı masalar için bu işlem yapılamaz!',
//                                   type: DialogType.warning);
//                             }
//                             break;
//                           //! change price code should be here
//                           //! selectProducts ->  icerisinde secili olan product lar bulunuyor!
//                           case "Change price":
//                             var productList = state.selectProducts;
